    ...
    public class Keystone : IDisposable
    {
        ...
        public event Resolver ResolveSymbol
        {
            add
            {
                ...
                {
                    var errr = KeystoneImports.SetOption(engine, KeystoneOptionType.KS_OPT_SYM_RESOLVER, Marshal.GetFunctionPointerForDelegate(internalImpl));
            ...
            remove
            {
                ...
                {
                    var errr =  KeystoneImports.SetOption(engine, KeystoneOptionType.KS_OPT_SYM_RESOLVER, IntPtr.Zero);
